...
class Website3DDemo {
  ...
  _Initialize() {
    ...
    this._LoadAnimatedModelAndPlay(
        './resources/myc/', 'main.fbx',
        'magicclap.fbx', new THREE.Vector3(0, 0, 0));

    this._LoadAnimatedModelAndPlay(
        './resources/myc/', 'main.fbx',
        'phone.fbx', new THREE.Vector3(-20, 0, -20));
   ...
   // this.loasdEyoo('./resources/myc/','untitled.fbx',new THREE.Vector3(-20,0,-20));
...
/*loasdEyoo(path,modelFile,offset){
...
/*  _LoadModel() {
    ...
    loader.load('./resources/yes/scene.glb', (gltf) => {
  ...
  _LoadAnimatedModelAndPlay(path, modelFile, animFile, offset) {
    const loadere = new FBXLoader();
    loadere.setPath(path);
    loadere.load(modelFile, (fbx) => {
      fbx.scale.setScalar(0.1);
      fbx.traverse(c => {
        c.castShadow = true;
      });
